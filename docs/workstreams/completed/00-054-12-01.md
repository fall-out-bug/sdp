...
Raise `internal/evidence` test coverage from 74% to ≥80% by adding tests for Emit, EmitSync, keyData, and appendToFile. (Follow-up from @review F054 — sdp-8y0y.)
...
- [x] AC4: `go test ./internal/evidence/... -cover` reports ≥80% statements
...
1. Pre-build: `hooks/pre-build.sh 00-054-12` — PASSED
2. Guard: `sdp guard activate 00-054-12` — activated
...
- **Coverage:** 85.3% (was 74.0%) — AC4 met
