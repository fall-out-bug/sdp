...
- [x] AC4: All agents include: name, description, version, changes fields → Tracked in AGENT_VERSIONS.md
- [x] AC5: Create agent version index (`prompts/AGENT_VERSIONS.md`)
...
- AGENT_VERSIONS.md tracks all agents
...
scope_files:
  ...
  - prompts/AGENT_VERSIONS.md              # NEW — version index
