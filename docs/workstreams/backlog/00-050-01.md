...
**Acceptance Criteria:**
- [ ] AC1: Parse valid WS markdown → Go struct
...
**Builds on F041:**
- ✅ `sdp-plugin/go.mod` exists (from F041-05)
- ✅ `sdp-plugin/cmd/sdp/main.go` exists (from F041-05)
- ✅ `sdp-plugin/cmd/sdp/` directory exists (from F041-05)
