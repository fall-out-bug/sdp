...
**Builds on F041:**
- ✅ `sdp-plugin/go.mod` exists
- ✅ `sdp-plugin/cmd/sdp/main.go` exists
...
**Context:**
TDD runner is core to SDP workflow. Simplified from Python (800 LOC → 400 LOC). Context cancellation enables @oneshot to stop mid-execution.
